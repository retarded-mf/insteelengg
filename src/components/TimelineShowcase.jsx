      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-charcoal uppercase tracking-tighter leading-none mb-4">
            <EditText id="timeline_header_title" defaultValue="What We've Built" />
          </h2>
          <p className="text-gray-500 font-bold text-sm uppercase tracking-widest">
            <EditText id="timeline_header_subtitle" defaultValue="Landmark structures across India and beyond — delivered end-to-end" />
          </p>
        </div>
        ...
        >
          {activeEntry.projects.map((project, i) => {
            const cardId = `timeline_${activeYear}_${i}`;
            return (
              <div
                key={i}
                    ...
                    {project.stats.map((stat, j) => (
                      <div key={j}>
                        <div className="text-white font-black text-xl leading-none">
                          <EditText id={`${cardId}_stat_${j}_val`} defaultValue={stat.value} />
                        </div>
                        <div className="text-white/40 font-black text-[9px] uppercase tracking-widest mt-1.5">
                          <EditText id={`${cardId}_stat_${j}_label`} defaultValue={stat.label} />
                        </div>
                      </div>
                    ))}
                    <Link
