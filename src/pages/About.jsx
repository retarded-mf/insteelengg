      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          <div className="relative border-l-4 border-blue-grey ml-4 md:ml-0 md:left-1/2">
            {timeline.map((item, i) => (
              <div key={i} className={`mb-16 relative reveal-on-scroll ${i % 2 === 0 ? 'md:pr-12 md:text-right md:-left-[354px]' : 'md:pl-12 md:left-1'}`}>
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
            {[1, 2, 3, 4, 5, 6].map((_, i) => (
              <div key={i} className="reveal-on-scroll break-inside-avoid shadow-lg relative group">
                <img src={`https://images.unsplash.com/photo-1579546929518-9e396f3cc809?auto=format&fit=crop&q=80&w=600&h=${400 + (i % 3) * 100}`} alt="Award" className="w-full h-auto grayscale group-hover:grayscale-0 transition-opacity" />
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
             {[
               ...
               <div key={i} className="bg-white/5 p-8 border border-white/10 hover:border-primary-red transition-colors group cursor-pointer reveal-on-scroll">
